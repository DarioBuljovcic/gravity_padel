...
export default function Gallery() {
  const images = [
    "/about.webp",
    "/hero.jpeg",
    // We will duplicate the use of existing images for preview or the user can add more in the public folder.
    // For now we'll simulate a 4-image grid to showcase.
    "/about.webp",
    "/hero.jpeg"
  ];
